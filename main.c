...
void update_pos_children(Node* node, double leftmost_bound, double rightmost_bound, double level){
	...
	/* printf("rmb %f lmb %f for node %p\n", leftmost_bound, rightmost_bound, node); */
	/* update current node position */
	/* printf("before %f %f for node %p\n", node->pos.x, node->pos.y, node); */
	/* printf("update_pos_children\n"); */
	...
	/* printf("update_pos_children end\n"); */
}
...
void compute_root_bounds_from_selected_and_update_pos_children(Node* node, double leftmost_bound, double rightmost_bound, double level){
	/* printf("crbfsaupc %p %lf %lf\n",node, leftmost_bound, rightmost_bound); */
	if (node == graph.root){
		/* printf("ROOT BOUNDS: %lf %lf \n", leftmost_bound, rightmost_bound); */
	...
	// TODO set parent node bounds relative to the child idx
